<html lang="en" class="gr__adminlte_io" style="height: auto;"><head>
  <meta charset="utf-8">
...
<body class="sidebar-mini gorgias-loaded" data-gr-c-s-loaded="true" style="height: auto;">
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 608.4px;">
    ...
    <a href="index3.html" class="brand-link">
      <img src="./img/appointment2.png" alt="Scheduler Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">TYC Scheduler</span>
    </a>
...
<span class="gorgias-qa-btn"><span class="gorgias-qa-btn-badge"></span></span><div class="gorgias-qa-tooltip">Search templates (CTRL+Space)</div><div class="qt-dropdown">
